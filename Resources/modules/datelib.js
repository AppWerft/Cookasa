...
function prettyDate(time) {
	...
	return day_diff == 0 && (diff < 60 && "gerade eben" || diff < 120 && "vor einer Minute" || diff < 3600 && Math.floor(diff / 60) + " vor einigen Minuten" || diff < 7200 && "vor einer Stunde" || diff < 86400 && "über " + Math.floor(diff / 3600) + " hours ago") || day_diff == 1 && "Gestern" || day_diff < 7 && day_diff + " days ago" || day_diff < 31 && Math.ceil(day_diff / 7) + " week" + ((Math.ceil(day_diff / 7)) == 1 ? "" : "s") + " ago";
}